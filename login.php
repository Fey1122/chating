  ...
  if($count > 0)
 {
  $result = $statement->fetchAll();
    foreach($result as $row)
    {
      ...
      {
       $message = "<label>Kata sandi salah !</label>";
      }
    }
 }
 else
 {
  $message = "<label>Username salah !</labe>";
 }
}

?>

   <h3 align="center">UKPBJ Kabupaten Pegunungan Bintang</a></h3><br />
	...
	<a href="register.php" class="btn btn-primary btn-lg btn-block btn-rounded">Register</a>
      </div>
     </form>
